    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('books.show', ['book' => $book['book_id']]) }}">{{ $book['title'] }}</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('books.update', ['book' => $book['book_id']]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('year_published') is-invalid @enderror"
                            ...
                            value="{{ old('year_published', $book['year_published']) }}" min="1800"
                            max="{{ date('Y') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('quantity_available') is-invalid @enderror"
                            ...
                            value="{{ old('quantity_available', $book['quantity_available']) }}" required min="0">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="{{ route('books.show', ['book' => $book['book_id']]) }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
